angular.module('fiona', ['ngRoute','fiona.services', 'blueimp.fileupload', 'ngJsTree', 'angucomplete'])
...
// Report - BEGIN
    // 统计报表
            // Dashboard
            .when('/amchart/dashboard', {
                controller: 'AmchartController',
                templateUrl: 'views/report/amchart/dashboard.html'
            })
// Report - END
