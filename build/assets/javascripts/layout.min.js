...
var Layout = function() {
    var e = "images/", a = "stylesheets/", t = App.getResponsiveBreakpoint("md"), i = function() {
        ...
        if (s.hasClass("page-footer-fixed")===!0 && s.hasClass("page-sidebar-fixed")===!1) {
            ...
            if (s.hasClass("page-sidebar-fixed"))
                e = n(), s.hasClass("page-footer-fixed")===!1 && (e -= $(".page-footer").outerHeight());
            else {
        ...
        // 一级菜单单击事件监听
        $(".page-sidebar-menu").on("click", "li > .sub-menu > .nav-item > a.nav-link", function(e) {
            s('click', this);
        }),
        ...
        $(".full-height-content").each(function() {
            ...
            if (e = App.getViewPort().height - $(".page-header").outerHeight(!0) - $(".page-footer").outerHeight(!0) - $(".page-title").outerHeight(!0) - $(".page-bar").outerHeight(!0), a.hasClass("portlet")) {
                ...
                App.destroySlimScroll(a.find(".full-height-content-body")), App.getViewPort().width >= t && a.hasClass("full-height-content-scrollable") ? (e -= 35, a.find(".full-height-content-body").css("height", e), App.initSlimScroll(a.find(".full-height-content-body"))) : a.css("min-height", e)
        })
    };
    return {
        initHeader: function() {
        ...
        getLayoutImgPath: function() {
            alert(App.getAssetsPath() + e);
            return App.getAssetsPath() + e
        },
        getLayoutCssPath: function() {
            alert(App.getAssetsPath() + a);
